...
const BOTNAME = 'ADAMS-MD|-WA-BOT™';
const FOOTERNAME = '> A D A M S -  ＭＤ - Ｖ4';
global.owner = process.env.OWNER_NUMBER  || '94701992015' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=CJE1iArS#o_nypcHRpdwljIBYgYF97r92DXofgUvG2kYuJSkbvYQ' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "237670507356,237620943836" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '1536': process.env.MAX_SIZE,/*add this in megabytes*/    
OWNER_NAME: process.env.OWNER_NAME || 'LOGAN ADAMS' ,
